<?php
/**
 * TheAtlantic_Sniffs_NamingConventions_CamelCapsFunctionNameSniff.
 *
 * PHP version 5
 *
 * @category  PHP
 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class TheAtlantic_Sniffs_NamingConventions_CamelCapsFunctionNameSniff extends PHP_CodeSniffer_Standards_AbstractScopeSniff
{
    ...
    /**
     * Constructs a TheAtlantic_Sniffs_NamingConventions_CamelCapsFunctionNameSniff.
     */
    ...
    protected function processTokenWithinScope(PHP_CodeSniffer_File $phpcsFile, $stackPtr, $currScope)
    {
        ...
        $strict = $this->strict;
        $isFalse = function($val) { return (!$val); };
        $isCamelCaps = array_map(function($m) use ($strict) {
            return (!strlen($m) || PHP_CodeSniffer::isCamelCaps($m, false, true, $strict));
        }, explode('_', $methodName));
        $camelCapsErrors = array_filter($isCamelCaps, $isFalse);
        if (count($camelCapsErrors)) {
